            ...
            <form>
                ...
                <div class="form-check text-start my-3">
                    <span>
                        ...
                        <a class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="./signup.php"> Register</a>
                    </span>
                ...
                <button class="btn btn-primary w-100 py-2 mb-3" id="login" type="submit">Login</button>
